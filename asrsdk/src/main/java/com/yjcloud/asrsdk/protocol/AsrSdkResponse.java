...
public class AsrSdkResponse {
	...
	protected static final Log LOG = LogFactory.getLog(AsrSdkResponse.class);
		...
		if(map.containsKey("result")){
			 Map<String,Object> resultMap = (Map<String, Object>) map.get("result");
		      ...
		      if (resultMap.containsKey("text")) {
		    	  ...
		    	  try {
		    		  String decodetxt = new String(Base64.decodeBase64(txt.getBytes()), "utf-8");
		    		  this.result.setText(decodetxt);
		    	  } catch (UnsupportedEncodingException e) {
					LOG.warn("识别结果decode异常,异常原因:{}"+e.getMessage());
					e.printStackTrace();
		    	  }
		      }
		}
